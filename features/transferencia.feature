# language: pt
Feature: Inicialização segura do internet banking
  ...
  Scenario: Sistema deve criar as contas iniciais ao iniciar
  ...
  Scenario: Cliente deve conseguir consultar saldo depois da inicialização
    Quando o sistema inicializa o banco de dados
